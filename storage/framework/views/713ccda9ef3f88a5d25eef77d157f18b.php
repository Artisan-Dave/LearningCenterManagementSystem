                                            ...
                                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-100">
                                                ...
                                                <td class="lg:-p-2 sm:-flex flex-wrap">
                                                    <div x-data="{ open: false, studentId: null, studentFullname: '' }">
                                                        ...
                                                        <a href="<?php echo e(route('student.edit', ['student_id' => urlencode(Crypt::encrypt($student->student_id))])); ?>"
                                                        ...
                                                        <a href="<?php echo e(route('student.create-balance', ['student_id' => urlencode(Crypt::encrypt($student->student_id))])); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\dashboard\payment-system\resources\views/students/main.blade.php ENDPATH**/ ?>