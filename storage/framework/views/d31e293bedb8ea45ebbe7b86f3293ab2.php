...
<?php endif; ?>
<?php $component->withAttributes(['value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($search),'placeholder' => 'Search students...']); ?>
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-100">
                                                ...
                                                <td
                                                    ...
                                                    <a href="<?php echo e(route('students.show',$student->id)); ?>"> <?php echo e($student->full_name); ?> </a>
                                                </td>
                                                <td
                                                ...
                                                <td class="border-">
                                                    <div x-data="{ open: false, studentId: null, studentFullname: '' }" class="flex items-center gap-3">
                                                        ...
                                                        <button
                                                            @click="open = true; studentId=<?php echo e($student->id); ?>; studentFullname='<?php echo e($student->full_name); ?>'"
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\lcms\resources\views/students/index.blade.php ENDPATH**/ ?>